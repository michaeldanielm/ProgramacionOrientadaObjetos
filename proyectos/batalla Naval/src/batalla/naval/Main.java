...
public class Main {
		...
		//Ingresar tama�o del Tablero y verificacion
		do{
		System.out.println("Ingrese tama�o del Tablero NO debe ser mayor a 10");
		tam=sc.nextInt();
		if(tam >10 || tam < 1){
		...
		System.out.println("Ingrese 1ra coordenada para el barco N�:"+(i+1));
		coordenada1 = sc.next();
		...
		System.out.println("Ingrese 2da coordenada para el barco N�:"+(i+1));
		coordenada2 = sc.next();
